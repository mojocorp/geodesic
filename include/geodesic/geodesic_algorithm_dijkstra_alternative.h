...
class GeodesicAlgorithmDijkstraAlternative : public GeodesicAlgorithmBase
{
  public:
    ...
    virtual unsigned best_source(SurfacePoint& point, // quickly find what source this point belongs
...
inline unsigned
GeodesicAlgorithmDijkstraAlternative::best_source(
  SurfacePoint&
  ...
  double& best_source_distance)
{
    if (point.type() == VERTEX) {
        ...
        std::vector<vertex_pointer>
          possible_vertices; // initialize vertices directly visible from sources
...
inline void
GeodesicAlgorithmDijkstraAlternative::trace_back(
